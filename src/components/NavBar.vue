...
<template>
  <header class="header z-40">
    <RouterLink
      class="w-12 h-12 absolute xl:fixed m-5 select-none outline-none flex items-center justify-center"
      to="/"
      focusable="false"
    >
      <Logo />
    ...
    <nav class="nav">
      ...
      <div class="right" print:op0>
        ...
        <RouterLink to="/talks" title="Publications">
          <span class="lt-md:hidden">Publications</span>
          <div i-ri-book-read-line class="md:hidden" />
        </RouterLink>
        ...
        <RouterLink to="/posts" title="Blog & Vlogs">
